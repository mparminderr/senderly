                ...
                <div className={"seamless-icons m-auto mr-0"}>
                    <div className={"circle"}>
                        <div className={"icons icons-top-left top-0"}>
                            <img src={icon1} className={"object-contain w-full h-full"} alt={"seamless-icons"}/>
                        </div>
                        <div className={"icons icons-top-right top-0 flex justify-center"} >
                            <img src={icon2} className={"object-contain w-1/2 h-auto"} alt={"seamless-icons"}/>
                        </div>
                        <div className={"icons icons-bottom-right bottom-0 flex justify-center"}>
                            <img src={icon3} className={"object-contain w-1/2 h-auto"} alt={"seamless-icons"}/>
                        </div>
                        <div className={"icons icons-bottom-left bottom-0 flex justify-center"}>
                            <img src={icon4} className={"object-contain w-1/2 h-auto"} alt={"seamless-icons"}/>
                        </div>
                    </div>
                </div>
            </div>
